...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "CrestPoint CRM" },
      { name: "description", content: "CrestPoint Management CRM — shared landlord and tenant workspace." },
      { name: "author", content: "CrestPoint Management" },
      { property: "og:title", content: "CrestPoint CRM" },
